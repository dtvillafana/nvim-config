return {
    ...
    config = function()
        ...
        keymap('n', '<leader>de', function() dapui.toggle() end, opts)
        keymap('n', '<leader>ds', function() dap.continue() end, opts)
        ...
        keymap('n', '<Leader>dB', function() dap.set_breakpoint() end, opts)
        keymap('n', '<Leader>dbl', function() dap.set_breakpoint(nil, nil, vim.fn.input('Log point message: ')) end, opts)
