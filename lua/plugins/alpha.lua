    ...
    config = function ()
        ...
        local buttons = {
            ...
            val = {
                ...
                button("c", " -> Set Color Scheme", ":colorscheme catppuccin-frappe<CR>"),
                -- button("e", " -> New file", ":ene <BAR> startinsert <CR>"),
                -- button("e", " -> New file", ":RnvimrToggle <CR>"),
                -- button("p", " -> Find project", ":Telescope projects <CR>"),
                button("r", " -> Recently used files", "<cmd>lua require('telescope').extensions.frecency.frecency({ workspace = 'CWD' })<CR>"),
