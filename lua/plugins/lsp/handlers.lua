...
local function lsp_keymaps(bufnr)
    ...
    --#region "alternate to defaults according to vim grammar"
    ...
    vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>d[d", '<cmd>lua vim.diagnostic.goto_prev({ border = "rounded" })<CR>', opts)
    vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>dgl", '<cmd>lua vim.diagnostic.open_float(0, { scope = "line", border = "rounded" })<CR>', opts)
    vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>d]d", '<cmd>lua vim.diagnostic.goto_next({ border = "rounded" })<CR>', opts)
